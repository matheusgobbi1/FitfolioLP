    ...
    <>
      <div style={containerStyle}>
        <header style={headerStyle}>
          ...
          >
            <ChevronLeft size={24} />
            <span style={{ marginLeft: "0.25rem" }}>Voltar</span>
          </button>
        ...
        <div>
          ...
          <p style={bulletPointStyle}>• Fornecer, manter e melhorar nossos Serviços;</p>
          <p style={bulletPointStyle}>• Processar e concluir transações e enviar informações relacionadas, incluindo confirmações de compra e faturas;</p>
          <p style={bulletPointStyle}>• Enviar avisos técnicos, atualizações, alertas de segurança e mensagens de suporte e administrativas;</p>
          <p style={bulletPointStyle}>• Responder a seus comentários, perguntas e solicitações, e fornecer atendimento ao cliente;</p>
          <p style={bulletPointStyle}>• Comunicar-se com você sobre produtos, serviços, ofertas, promoções, recompensas e eventos oferecidos por nós e outros, e fornecer notícias e informações que achamos que serão de seu interesse;</p>
          <p style={bulletPointStyle}>• Monitorar e analisar tendências, uso e atividades em conexão com nossos Serviços;</p>
          <p style={bulletPointStyle}>• Personalizar e melhorar os Serviços e fornecer conteúdo, recursos e/ou anúncios adaptados aos seus interesses e preferências;</p>
          <p style={bulletPointStyle}>• Processar e entregar inscrições em concursos e recompensas;</p>
          <p style={bulletPointStyle}>• Detectar, investigar e prevenir transações fraudulentas e outras atividades ilegais e proteger os direitos e a propriedade do FitFolio e de outros.</p>

          <h2 style={headingStyle}>3. Como Compartilhamos Suas Informações</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>4. Retenção de Dados</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>5. Segurança de Dados</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>6. Seus Direitos e Escolhas</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>7. Privacidade Infantil</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>8. Transferências Internacionais de Dados</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>9. Alterações nesta Política de Privacidade</h2>
          <p style={paragraphStyle}>
          ...
          <h2 style={headingStyle}>10. Contate-nos</h2>
          <p style={paragraphStyle}>
